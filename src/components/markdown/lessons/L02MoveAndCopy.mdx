...
[^1]:
    There's actually at least 8, but only two that show up in 99% of all
    programming. The rest exist for over-optimisation, compatability with C,
    and [strange operating systems][win] that insist on using UTF-16.
