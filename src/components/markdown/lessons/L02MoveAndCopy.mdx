...
this indirection, this is called passnbt reference and may look something like
this:
...
and destroyed. This means that `"Hello"` no longer exists to he passed to the
...
If the code example was the following, for example:
