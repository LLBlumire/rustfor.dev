...
Enums can be destructured, but this is more complex and will be covered in
greater detail in a later lesson on pattern matching. This destructuring is the
only coherent way to access the internal state of a variant.
